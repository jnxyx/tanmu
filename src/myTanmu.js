...
(function() {
    ...
    function tanmu(options) {
        ...
        this.msgTarget = 0;
        this.container = global.document.defaultView.document.getElementById(options.containerId);
    ...
    proto.create = function(words) {
        ...
        var element = global.document.defaultView.document.createElement('span');
